...
module.exports = function(mbtiles) {
  mbtiles.createReadStream = function(options) {
    ...
    var tileSource = _(function(push, next) {
      // fetch info before querying so that options will have been updated
      // before the synchronous filter function is called for the first time
